...
export function onTouch(el, callback, capture){
    ...
    this.distX;
    this.distY;
    this.threshold = 150; //required min distance travelled to be considered swipe
    ...
    this.touchsurface.addEventListener('touchmove', function touchHandlerDefault(e){
        // console.log(e);
        let touchList = e.changedTouches;
        ...
        //horizontal swipe if X travel is longer than Y
