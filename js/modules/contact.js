...
import { selectSwitcher } from "../select-switch";
    ...
    body: {
      ...
      contactListItems: [
        ...
        },
        {
          ...
          topText: "Office",
          bottomText:
            "115114, г. Москва, ул. Летниковская, д. 2, стр. 1, офис 453"
        }
      ],
      countryPoints: [
        {
...
window.addEventListener("load", function() {
  ...
  const init = () => {
    ...
    WE.tileLayer(
      ...
      {
        style:
          "https://api.maptiler.com/maps/683bb469-f461-4f7b-a52e-ff4aad94b3fd/style.json?key=DV0Wcpnxa5xR0MwfweYz"
      }
    ).addTo(map);
  ...
  const addBounds = bounds =>
    map.panInsideBounds(bounds, { tilt: 10, duration: 2 });
