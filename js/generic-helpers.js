...
// Switch Animation
export function animateSwitch(elementSelector, switchFlag, delayInterval, delayStart) {
...
export function scrollFromScreen(sectionTopSelector) {
    document.querySelector(".hint-from-top").addEventListener("click", () => {
        ...
        let screenHeight = document.querySelector(sectionTopSelector).clientHeight || 0;
       
        scrollingElement.scrollTop = screenHeight;
    });
}
